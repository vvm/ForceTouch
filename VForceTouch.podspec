#
#  Be sure to run `pod spec lint VForceTouch.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Use force touch as a gesture recognizer.
  ...
  s.source_files  = "ForceTouch","ForceTouch/Class/*.{h,m}"
